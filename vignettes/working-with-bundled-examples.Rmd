...
`inst/exercises`. These are useful for testing a fresh installation or for
...
The helper script `generate_examples.R` exports each bundled exercise
...
## Adapt an exercise for your own pool

A practical workflow is:

1. Start from the closest bundled exercise.
